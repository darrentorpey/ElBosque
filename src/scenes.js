...
game.makeScene('Game', function() {
// Crafty.scene('Game', function() {
  // A 2D array to keep track of all occupied tiles
  this.occupied = new Array(Game.map_grid.width);

  _.times(Game.map_grid.width, function(x) {
    this.occupied[x] = new Array(Game.map_grid.height);
    _.times(Game.map_grid.height, function(y) {
  ...
  this.show_victory = Crafty.bind('VillageVisited', function() {
  ...
  Crafty.unbind('VillageVisited', this.show_victory);
});
